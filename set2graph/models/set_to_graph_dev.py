...
from models.set_to_graph import SetToGraph   # building block to CONTROLLER


class SetToGraphDev(nn.Module):
    def __init__(self, in_features,
            out_features, set_fn_feats, method, hidden_mlp,
            predict_diagonal, attention, cfg=None):
        """
        SetToGraph model.
        ...
        """
        super(SetToGraphDev, self).__init__()
